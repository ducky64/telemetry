...
\subsubsection{KV Records}
Record ID 0x40, uint8: element data sub-type: same as for numeric \\
Record ID 0x41, uint8: element data length (in bytes) \\
Record ID 0x42, uint32: array count (in number of elements)
\subsubsection{Data format}
Raw data in network order.
